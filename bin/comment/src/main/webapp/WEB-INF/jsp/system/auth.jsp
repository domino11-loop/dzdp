                ...
                <table class="x-form-table">
                    ...
                    <tr class="line">
                        ...
                        <td width="90%">
                            ...
                            <input type="text" class="normal-input" id="groupName" name="groupName"
                                   style="width: 240px;"/>
                        </td>
                    </tr>
                    <tr>
                ...
                <table class="x-form-table">
                    ...
                    <tr class="line">
                        ...
                        <td width="90%">
                            ...
                            <input type="text" class="normal-input" id="menuName" name="menuName"
                                   style="width: 240px;"/>
                        </td>
                    </tr>
                    <tr class="line">
                ...
                <table class="x-form-table">
                    ...
                    <tr class="line">
                        ...
                        <td width="90%">
                            ...
                            <input type="text" class="normal-input" id="actionName" name="actionName"
                                   style="width: 240px;"/>
                        </td>
                    </tr>
                    <tr class="line">
                        ...
                        <td width="90%">
                            <input type="text" class="normal-input" id="actionUrl" name="actionUrl"
                                   style="width: 240px;"/>
                        </td>
                    </tr>
                    <tr class="line">
