        ...
        <div class="rightCont">
            ...
            <table class="tab1" width="100%">
                ...
                <tr>
                    ...
                    <td width="30%">
                        <input name="title" value="${addParam.title}" class="allInput" style="width:100%;"
                               type="text"/>
                    </td>
                    <td align="right" width="15%">副标题<font color="red">*</font>：</td>
                    <td width="30%">
                        <input name="subtitle" value="${addParam.subtitle}" class="allInput" style="width:100%;"
                               type="text"/>
                    </td>
                </tr>
                <tr>
                        ...
                        <select name="city">
                            <c:forEach items="${cityList}" var="item">
                                <option value="${item.code}"
                                        <c:if test="${item.code == addParam.city}">selected="selected"</c:if>
                                >${item.name}</option>
                            </c:forEach>
                        </select>
                    </td>
                    ...
                    <td width="30%">
                        <select name="category">
                            <c:forEach items="${categoryList}" var="item">
                                <option value="${item.code}"
                                        <c:if test="${item.code == addParam.category}">selected="selected"</c:if>
                                >${item.name}</option>
                            </c:forEach>
                        </select>
                    </td>
                ...
                <tr>
                    ...
                    <td width="30%">
                        <input type="hidden" name="img" value="${addParam.img}"/>
                ...
                <tr>
                    ...
                    <td width="30%">
                        <input name="price" value="${addParam.price}" class="allInput" style="width:100%;"
                               type="text"/>
                    </td>
                    <td align="right" width="10%">距离(单位：米)<font color="red">*</font>：</td>
                    <td width="30%">
                        <input name="distance" value="${addParam.distance}" class="allInput" style="width:100%;"
                               type="text"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="30%" colspan="3">
                        <textarea name="desc" rows="5" style="width:100%;resize:none;">${addParam.desc}</textarea>
                    </td>
                </tr>
                </tbody>
            </table>
