...
<form method="post" action="${basePath}/session" id="mainForm">
    ...
    <div id="header">
     ...
     <!--           <li onclick='clickFirstMenu(this)'><a><span>系统管理</span></a></li>
                <li onclick='clickFirstMenu(this)'><a><span>内容管理</span></a></li>
                <li onclick='clickFirstMenu(this)'><a><span>统计报表</span></a></li>
     -->    </ul>
        </div>
    </div>
    <div id="container">
