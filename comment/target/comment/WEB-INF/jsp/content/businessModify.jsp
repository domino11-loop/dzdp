...
<form id="mainForm" method="post" action="${basePath}/businesses/${modifyObj.id}" enctype="multipart/form-data">
    ...
    <div class="right">
        ...
        <div class="rightCont">
            <p class="g_title fix">修改商户及添加招牌商品</p>
            <table class="tab1" width="100%">
                <tbody>
                <tr>
                    <td align="right" width="15%">标题<font color="red">*</font>：</td>
                    <td width="30%">
                        <input name="title" value="${modifyObj.title}" class="allInput" style="width:100%;"
                               type="text"/>
                    </td>
                    <td align="right" width="15%">副标题<font color="red">*</font>：</td>
                    <td width="30%">
                        <input name="subtitle" value="${modifyObj.subtitle}" class="allInput" style="width:100%;"
                               type="text"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="30%">
                        <input name="price" value="${modifyObj.price}" class="allInput" style="width:100%;"
                               type="text"/>
                    </td>
                    <td align="right" width="10%">距离(单位：米)<font color="red">*</font>：</td>
                    <td width="30%">
                        <input name="distance" value="${modifyObj.distance}" class="allInput" style="width:100%;"
                               type="text"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="30%" colspan="3">
                        <textarea name="desc" rows="5" style="width:100%;resize:none;">${modifyObj.desc}</textarea>
                    </td>
                </tr>
                </tbody>
            </table>
